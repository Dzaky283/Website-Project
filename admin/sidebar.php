...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="./index_1.php" ><i class="fa fa-home"></i> Dashboard</a>
    ...
    <a href="#sizes"   onclick="showSizes()" ><i class="fa fa-th"></i> Courses</a>
    <a href="#productsizes"   onclick="showProductSizes()" ><i class="fa fa-th-list"></i> Team</a>    
